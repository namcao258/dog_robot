"""
Trajectory Controller for Nova-SM3 Quadruped Robot
Generate and visualize leg trajectories with IK

Features:
- Predefined trajectories (walking gait, circle, lissajous)
- Custom trajectory design
- Real-time animation
- Joint angle visualization

Author: Trajectory Control System
Date: 2025-12-12
"""
...
class TrajectoryControllerGUI:
    ...
    def setup_ui(self):
        ...
        init_frame = ttk.LabelFrame(control_frame, text="Initial Configuration", padding=10)
        ...
        self.ax_3d.set_title("3D Trajectory & Leg Configuration", fontweight='bold')
        ...
        self.ax_angles.set_title("Joint Angles vs Time", fontweight='bold')
